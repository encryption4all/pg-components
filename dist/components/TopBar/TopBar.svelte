<script>import AttributeForm from '../AttributeForm/AttributeForm.svelte';
import Logo from '../../images/pg_logo_no_text.svg';
import LogoGrey from '../../images/pg_logo_grey_no_text.svg';
